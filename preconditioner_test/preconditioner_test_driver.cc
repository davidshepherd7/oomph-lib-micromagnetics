...
namespace Inputs
{
  ...
  {
    h_app.assign(3,0.0);
    double h_strength = (80e-3 / mag_parameters::mu0);
    h_app[0] = h_strength;
    h_app[1] = h_strength;
    h_app[2] = h_strength;
...
ThreeDHybridProblem()
{
  ...
  if(Inputs::GMRES)
	...
	new MicromagneticsBlockDiagonalPreconditioner<CRDoubleMatrix>;
  ...
  unsigned nx = Inputs::nx, ny = Inputs::ny, nz = Inputs::nz;
