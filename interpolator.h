...
namespace oomph
{
 ...
 namespace InterpolatorHelpers
 {
  ...
  inline double not_yet_calculated_value() {return -987654.321;}


  /// Check to see if variables are initialised
  inline bool uninitialised(double var) {return var == not_yet_calculated_value();}
 ...
 */
 ...
 protected:
  ...
  bool uninitialised(double var) {return var == not_yet_calculated_value();}
