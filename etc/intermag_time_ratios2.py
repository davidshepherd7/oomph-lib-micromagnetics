...
def main():
    ...
    for group in grouped:
        ...
        rk2_time = sp.mean([d['mean_step_time'] for d in group if d['-ts'] == 'rk2'])
        rk4_time = sp.mean([d['mean_step_time'] for d in group if d['-ts'] == 'rk4'])
        ...
        r = {
             ...
             '-ref' : group[0]['-ref'],
             'rk2_ratio' : imr_time/rk2_time,
             'rk4_ratio' : imr_time/rk4_time,
             }
    ...
    dis_rk4 = sp.mean([d['rk4_ratio'] for d in results if d['-ms-method'] == 'disabled'])
    ...
    print("decoupled ms time per step ratio rk4:", dec_rk4)
    print("disabled ms time per step ratio rk4:", dis_rk4)
