...
./semi_implicit_mm_driver -dt 0.001 -tmax 0.001 -ref 3 -mesh ut_sphere -solver superlu -happ minus_z -initm exactly_z -ts midpoint -doc-interval all -outdir $SPHERE_DIR -mag-params 'simple-llg' \
    > $SPHERE_DIR/stdout
