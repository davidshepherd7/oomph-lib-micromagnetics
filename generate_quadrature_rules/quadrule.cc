...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "BASHFORTH_SET - Fatal error!\n";
    std::cerr << "  Illegal value of N = " << n << "\n";
    std::cerr << "  Legal values are 1 through 10, 12, 14, 16, 18 or 20.\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "BDF_SET - Fatal error!\n";
    std::cerr << "  Illegal N requested = " << n << "\n";
    exit ( 1 );
  }
...
# define N_MAX 19
  ...
  {
    std::cerr << "\n";
    std::cerr << "BDFC_SET - Fatal error!\n";
    std::cerr << "  Input order N = " << n << "\n";
    std::cerr << "  exceeds maximum order N_MAX = " << N_MAX << "\n";
    exit ( 1 );
  }
  for ( i = 0; i < n; i++ )
  {
...
# define ORDER_MAX 19
  ...
  {
    std::cerr << "\n";
    std::cerr << "BDFP_SET - Fatal error!\n";
    std::cerr << "  Input order ORDER = " << order << "\n";
    std::cerr << "  exceeds maximum order ORDER_MAX = " << ORDER_MAX << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_COS - Fatal error!\n";
    std::cerr << "  Illegal value of N = " << n << "\n";
    exit ( 1 );
  }
  return;
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_COS2 - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  return;
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_LOG - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  return;
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_X0_01 - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  return;
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_X1 - Fatal error!\n";
    std::cerr << "  Illegal input value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  return;
}
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_X1_01 - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_X2 - Fatal error!\n";
    std::cerr << "  Illegal input value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  return;
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LEGENDRE_SET_X2_01 - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "LOBATTO_COMPUTE - Fatal error!\n";
...
//
{
  ...
  else
  {
    ...
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    std::cerr << "  Legal values are between 2 and 20.\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "MOULTON_SET - Fatal error!\n";
    std::cerr << "  Illegal value of ORDER = " << order << "\n";
    std::cerr << "  Legal values are 1 through 10, 12, 14, 16, 18, or 20.\n";
    exit ( 1 );
  }
...
//
{
  ...
  else
  {
    ...
    std::cerr << "  Illegal value of N = " << n << "\n";
    std::cerr << "  Legal values are 1 to 7, and 9.\n";
    exit ( 1 );
  }
//
//  Set the abscissas.
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "SUM_SUB - Fatal error!\n";
    std::cerr << "  Nonpositive value of ORDER = " << order << "\n";
    exit ( 1 );
  }
  ...
  if ( nsub < 1 )
  {
    std::cerr << "\n";
    std::cerr << "SUM_SUB - Fatal error!\n";
    std::cerr << "  Nonpositive value of NSUB = " << nsub << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    std::cerr << "\n";
    std::cerr << "SUMMER_GK - Fatal error!\n";
    std::cerr << "  ORDERK must equal 2 * ORDERG + 1.\n";
    std::cerr << "  The input value was ORDERG = " << orderg << "\n";
    std::cerr << "  The input value was ORDERK = " << orderk << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  *error = 0.0;
  ...
  {
    std::cerr << "\n";
    std::cerr << "SUM_SUB_GK - Fatal error!\n";
    std::cerr << "  ORDERK must equal 2 * ORDERG + 1.\n";
    std::cerr << "  The input value was ORDERG = " << orderg << "\n";
    std::cerr << "  The input value was ORDERK = " << orderk << "\n";
    exit ( 1 );
