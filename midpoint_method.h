...
namespace oomph
{
  ...
  public:
      ...
      Dy_tnph_storage_index(nprev_values()+2)
    {
      ...
      // (Actually we would like to be able to calculate this as (y_n+1 +
      // y_n)/2 but it isn't actually used that I've seen! So we
      // can't... Have to use BDF1 followed by an update instead.)
      Weight(0, 0) = 1.0;
    }
